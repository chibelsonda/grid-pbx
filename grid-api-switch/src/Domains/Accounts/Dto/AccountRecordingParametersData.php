...
final readonly class AccountRecordingParametersData
{
    public function __construct(
        ...
        public ?string $preservedUrl = null,
    ) {}
    ...
    public function toSwitchData(): array
    {
        return array_filter([
            ...
            // Existing storage targets originate from Switch and are never accepted from the UI.
            'url' => $this->preservedUrl,
