      ...
      <div class="fixed inset-0 overflow-hidden">
        <div class="absolute inset-0 overflow-hidden">
          <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-8 sm:pl-12">
            ...
            >
              <DialogPanel
                class="pointer-events-auto flex w-screen max-w-lg flex-col bg-slate-50 shadow-2xl"
              >
                <header
                  class="flex shrink-0 items-center gap-3 border-b border-slate-200 bg-white px-5 py-4"
                >
                  ...
                  <button
                    type="button"
                    class="ml-auto grid size-9 shrink-0 place-items-center rounded-md border border-slate-200 bg-white text-slate-500 hover:border-brand-200 hover:bg-brand-50 hover:text-brand-600"
                ...
                <div class="min-h-0 flex-1 space-y-4 overflow-y-auto p-5">
                  <section class="card-surface overflow-hidden">
                    ...
                    <div class="space-y-4 p-4">
                      ...
                      <div
                        role="radiogroup"
                        aria-label="Application color scheme"
                    ...
                    <DisclosurePanel class="space-y-5 border-t border-slate-200 p-4">
                      <section v-for="region in themeRegions" :key="region">
                        <div class="mb-3 flex items-center gap-2">
                          <div>
                            <h3 class="text-xs font-semibold text-slate-700 capitalize">
                              {{ region }} style
                            </h3>
                        ...
                        >
                          ...
                          >
                            <span
                              ...
                              :class="
                                selectedTheme(region).id === theme.id &&
