...
<template>
  <AdvancedFormTabs v-model="selectedTabIndex" :tabs="tabs" aria-label="Device advanced sections">
      ...
      >
        <section class="grid gap-4 rounded-lg border border-slate-200 p-4">
          ...
          <ToggleSwitch
            ...
            @update:model-value="setRestrictionAction('closed_groups', $event ? 'deny' : 'inherit')"
          />
        </section>
