                ...
                >
                  <label class="grid gap-2">
                    ...
                    <FormListbox
                      ...
                      :invalid="
                        Boolean(error(target.value, direction.value, network.value, 'format'))
                      "
                      :options="[
                        { value: 'mp3', label: 'MP3' },
                        { value: 'wav', label: 'WAV' },
                  ...
                  <ToggleSwitch
                    v-model="
                      recording[target.value][direction.value][network.value].record_on_answer
                    "
                    label="Start on answer"
                  />
                  <ToggleSwitch
                    v-model="
                      recording[target.value][direction.value][network.value].record_on_bridge
                    "
