...
return new class extends Migration
{
    ...
    {
        Schema::create('kazoo_callflows', function (Blueprint $table) {
            ...
            $table->unique(['kazoo_account_id', 'kazoo_resource_id'], 'kc_account_resource_unique');
            $table->index(['kazoo_account_id', 'owner_kazoo_resource_id'], 'kc_account_owner_index');
        });
    }
    ...
    {
        Schema::dropIfExists('kazoo_callflows');
    }
};
