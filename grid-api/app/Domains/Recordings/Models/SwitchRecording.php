...
class SwitchRecording extends Model
{
    ...
    {
        return $this->belongsTo(SwitchCallDetailRecord::class, 'switch_call_detail_record_id', 'call_detail_record_id');
    }

    protected function casts(): array
    {
        return ['started_at' => 'datetime', 'duration_seconds' => 'integer', 'duration_milliseconds' => 'integer', 'content_length' => 'integer', 'has_audio' => 'boolean', 'last_synced_at' => 'datetime', 'sync_status' => ProjectionStatus::class, 'projection_version' => 'integer', 'switch_json' => 'array'];
    }

    protected static function newFactory(): SwitchRecordingFactory
    {
        return SwitchRecordingFactory::new();
    }
}
