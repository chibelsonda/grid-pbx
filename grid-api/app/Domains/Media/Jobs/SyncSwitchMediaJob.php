...
class SyncSwitchMediaJob implements ShouldBeUnique, ShouldQueue
{
    ...
    {
        return "media:{$this->switchAccountId}";
    }

    public function handle(MediaSynchronizationService $synchronization): void
    {
    ...
    public function failed(?Throwable $exception): void
    {
        ...
        $message = mb_substr($exception?->getMessage() ?? 'The Switch media synchronization failed.', 0, 2000);
        $run->update([
