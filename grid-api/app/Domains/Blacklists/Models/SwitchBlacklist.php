...
class SwitchBlacklist extends Model
{
    ...
    {
        return $this->hasMany(SwitchBlacklistEntry::class, 'switch_blacklist_id', 'blacklist_id')->orderBy('number');
    }
    ...
    protected static function newFactory(): SwitchBlacklistFactory
    {
        return SwitchBlacklistFactory::new();
    }
}
