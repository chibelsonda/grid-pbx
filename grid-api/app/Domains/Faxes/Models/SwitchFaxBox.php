...
{
    /** @use HasFactory<SwitchFaxBoxFactory> */
    ...
    {
        return $this->hasMany(SwitchFax::class, 'switch_fax_box_id', 'fax_box_id');
    }

    protected function casts(): array
    {
        return ['retries' => 'integer', 't38_enabled' => 'boolean', 'smtp_permission_list' => 'array', 'inbound_notification_emails' => 'array', 'outbound_notification_emails' => 'array', 'last_synced_at' => 'datetime', 'sync_status' => ProjectionStatus::class, 'projection_version' => 'integer', 'switch_json' => 'array'];
    }

    protected static function newFactory(): SwitchFaxBoxFactory
    {
        return SwitchFaxBoxFactory::new();
    }
}
