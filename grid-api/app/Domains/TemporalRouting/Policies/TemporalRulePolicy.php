...
class TemporalRulePolicy
{
    ...
    public function view(User $user, SwitchTemporalRule $rule, SwitchAccount $account): bool
    {
        return $rule->switch_account_id === $account->getKey() && $this->viewAny($user, $account);
    }
    ...
    public function update(User $user, SwitchTemporalRule $rule, SwitchAccount $account): bool
    {
        return $rule->switch_account_id === $account->getKey() && $this->create($user, $account);
    }

    public function delete(User $user, SwitchTemporalRule $rule, SwitchAccount $account): bool
    {
        return $this->update($user, $rule, $account);
    }
